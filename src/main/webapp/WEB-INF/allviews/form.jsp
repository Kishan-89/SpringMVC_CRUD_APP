...
<body>
	...
	<div class="container mt-5 text-center">
		...
		<form class="needs-validation mt-5" novalidate action="processBook"
			method="post">
			...
			<div class="form-row">
				...
				<div class="col-md-4 mb-3">
					<label for="validationCustom02">Author's Name</label> <input
						...
						placeholder="Author name" name="authorName" required>
					<div class="valid-feedback">Looks good!</div>
				</div>
				<div class="col-md-4 mb-3">
					<label for="validationCustomUsername">Published year</label>
					<div class="input-group">
						<div class="input-group-prepend"></div>
						<input type="text" name="publishedDate" class="form-control"
							id="validationCustomUsername" placeholder="yyyy"
